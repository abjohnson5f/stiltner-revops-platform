...
import { getCompetitorIntelligence, isApifyConfigured } from '@/lib/apify';
...
export async function POST(request: NextRequest) {
  try {
    ...
    const intelligence = await getCompetitorIntelligence(service, locations);
